        ...
        const fetchUserData = async () => {
            ...
            try {
                ...
                if (userDoc.exists()) {
                    ...
                    setTwoFactorVerified(userDoc.data().twoFactorVerified || false);
                    console.log("initial", userDoc.data().twoFactorVerified);
                }
            } catch (error) {
    ...
    const verifyOtp = async () => {
        ...
        console.log("Response Data:", response.data);  // This will log the response from your backend
            ...
            if (response.data.success) {
                ...
                await updateDoc(doc(db, "Users", auth.currentUser.uid), { twoFactorVerified: true});
    ...
    return (
        <section className="authentication-container">
            ...
            <form onSubmit={handleSubmit} noValidate>
                ...
                <small style={{ textAlign: "center" }}>If you&apos;ve lost your device or can&apos;t use your app, please contact <a>support@homespace.com</a>.</small>
            </form>
        </section>
    );
}
